...
class NotificationsUserFollowTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        followButton.frame = CGRect(x: contentView.width - 110, y: (contentView.height-30)/2, width: 100, height: 30)
        ...
        label.frame = CGRect(x: avatarImageView.right + 10, y: 0, width: labelSize.width, height: labelSize.height)
