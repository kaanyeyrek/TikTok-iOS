...
class ProfileViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let viewModel = ProfileHeaderViewModel(avatarImageURL: user.profilePictureURL, followersCount: followers.count, followingCount: following.count, isFollowing: isCurrentUserProfile ? nil : isFollower)
...
extension ProfileViewController: ProfileHeaderCollectionReusableViewDelegate {
    func profileHeaderCollectionReusableView(_ header: ProfileHeaderCollectionReusableView, didTapPrimaryButtonWith viewModel: ProfileHeaderViewModel) {
        ...
        if self.user.username.lowercased() == currentUsername {
        // Edit profile
