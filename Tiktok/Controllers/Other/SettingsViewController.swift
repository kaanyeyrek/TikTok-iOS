...
class SettingsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        sections = [SettingsSection(title: "Preferences", options:
            [SettingOption(title: "Save Video", handler: {}),
            ]),
                    SettingsSection(title: "Enjoying the app?", options: [SettingOption(title: "Rate App", handler: {
            DispatchQueue.main.async {
                Appirater.tryToShowPrompt()
                // UIApplication.shared.open(URL(string: "")!, options: [:], completionHandler: nil)
            }
        }),
            SettingOption(title: "Share app", handler: {
            DispatchQueue.main.async {
        ...
        SettingsSection(title: "INFORMATION", options:
            [SettingOption(title: "Terms Of Service", handler: { [weak self] in
                DispatchQueue.main.async {
            ...
            SettingOption(title: "Privacy Policy", handler: { [weak self] in
                DispatchQueue.main.async {
